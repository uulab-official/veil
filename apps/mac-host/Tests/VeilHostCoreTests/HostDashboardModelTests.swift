...
struct HostDashboardModelTests {
    ...
    func recordsFrameTimingAndCadenceForMirroredWindows() async throws {
        ...
        #expect(report.macWindowIntegration.frameLatencyHealth == "healthy")
        #expect(report.macWindowIntegration.frameLatencyBudgetMilliseconds == 1_000)
        #expect(report.macWindowIntegration.frameStaleTimeoutMilliseconds == 5_000)
        #expect(report.macWindowIntegration.slowestFrameWindowId == "hwnd:0003029A")
        #expect(report.macWindowIntegration.slowestFrameWindowTitle == "Untitled - Notepad")
        #expect(report.macWindowIntegration.slowestFrameAgeMilliseconds == 500)
    ...
    func reportsStaleFrameStreamsAndRestartAction() async throws {
        ...
        #expect(report.macWindowIntegration.frameLatencyHealth == "stale")
        #expect(report.macWindowIntegration.slowestFrameWindowId == "hwnd:0003029A")
        #expect(report.macWindowIntegration.slowestFrameAgeMilliseconds == 6_250)
        #expect(report.macWindowIntegration.frameLatencyRecommendedAction == "maintain-frame-streams")
    ...
    func promotesFirstFrameTimeoutToStaleFrameStream() async throws {
        ...
        #expect(report.macWindowIntegration.frameLatencyHealth == "stale")
        #expect(report.macWindowIntegration.slowestFrameWindowId == "hwnd:0003029A")
        #expect(report.macWindowIntegration.slowestFrameAgeMilliseconds == 8_250)
        #expect(report.macWindowIntegration.frameLatencyRecommendedAction == "maintain-frame-streams")
        #expect(maintainAction.isAvailable)
    }
    ...
    func buildsAppRuntimeStatusReportForHarnessAutomation() async throws {
        ...
        #expect(report.macWindowIntegration.delayedFrameWindowCount == 0)
        #expect(report.macWindowIntegration.staleFrameWindowCount == 0)
        #expect(report.macWindowIntegration.frameLatencyHealth == "waiting")
        #expect(report.macWindowIntegration.frameLatencyBudgetMilliseconds == 1_000)
        #expect(report.macWindowIntegration.frameStaleTimeoutMilliseconds == 5_000)
        #expect(report.macWindowIntegration.slowestFrameWindowId == "hwnd:0003029A")
        #expect(report.macWindowIntegration.slowestFrameWindowTitle == "Untitled - Notepad")
        #expect(report.macWindowIntegration.slowestFrameAgeMilliseconds == 0)
        #expect(report.macWindowIntegration.frameLatencyRecommendedAction == "wait-for-first-frame")
        #expect(report.macWindowIntegration.reason == "Windows app windows are mirrored and waiting for the first app screen frame.")
