...
struct VMProfileStoreTests {
    ...
    func preparesDefaultProfileSharedFolderAndVirtualDiskTogether() async throws {
        ...
        let optimizeScriptURL = agentBundleURL.appendingPathComponent("scripts/Optimize-VeilWindows.ps1")
        ...
        #expect(optimizeCommand.contains("Optimize-VeilWindows.ps1"))
        #expect(optimizeCommand.contains("-GuestToolsPath"))
        #expect(optimizeScript.contains("-Verb RunAs"))
        #expect(optimizeScript.contains("-Wait"))
        #expect(optimizeScript.contains("-RepairScriptPath"))
        #expect(optimizeScript.contains("-Elevated"))
