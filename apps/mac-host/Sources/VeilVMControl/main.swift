...
enum VMControlError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .missingAppRuntimeAction:
            "Missing app runtime action. Pass --action launch, focus, close, restore, clipboard, or type-text."
        case .unsupportedAppRuntimeAction(let action):
            "Unsupported app runtime action '\(action)'. Pass --action launch, focus, close, restore, clipboard, or type-text."
        case .missingWindowId:
...
struct VMControlArguments {
    ...
    enum Command: Equatable {
        ...
        case appRuntimeAction(json: Bool, demo: Bool, action: AppRuntimeAction, appId: String?, windowId: String?, text: String?)
...
struct VeilVMControl {
    ...
    private static func run(_ arguments: VMControlArguments) async throws {
        ...
        case .appRuntimeAction(let json, let demo, let action, let appId, let windowId, let text):
            try await runAppRuntimeAction(json: json, demo: demo, action: action, appId: appId, windowId: windowId, text: text)
