...
function validateCoherence(coherence, appId) {
  ...
  validateFrameLatency(coherence.initialFrameLatency, "initial-frame", "coherence.initialFrameLatency");
  validateFrameLatency(coherence.postInputFrameLatency, "post-input-frame", "coherence.postInputFrameLatency");
